  ...
  */
  ...
  const handleVideoEnd = useCallback(() => {
    ...
    if (videoLabel !== 'neutral') {
      ...
      setVideoSrc('/vids/emigg-v2/neutral.mp4', 'neutral')
    }
    ...
    (data: any) => {
      ...
      if (modelType === 'png' && data.emotion && setEmotion) {
        ...
        console.log(
          ...
          `/vids/emigg-v2/${data.emotion}.mp4`
        )
        setVideoSrc(`/vids/emigg-v2/${data.emotion}.mp4`, data.emotion)
      } else {
        console.log(
